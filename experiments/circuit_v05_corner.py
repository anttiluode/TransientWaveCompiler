"""Run the preregistered TW-1A v0.5 phase-symmetric simultaneous corner."""
...
def config_for(seed: int) -> TW1ACircuitV05Config:
    return TW1ACircuitV05Config(
        weight_bits=8,
        self_bits=12,
        dac_bits=8,
        error_dac_bits=10,
...
def main() -> None:
    ...
    Path("circuit-v05-corner.json").write_text(
        json.dumps(
            {
                "experiment": "tw1a-v05-phase-symmetric-simultaneous-corner",
                "preregistration": "docs/CIRCUIT_V05_CORNER_PREREG.md",
                "seeds": SEEDS,
                "iterations": 30,
                "step_size": 0.20,
